...
$packages["github.com/gopherjs/gopherjs/js"] = (function() {
	...
	M = $pkg.M = $newType(4, "Map", "js.M", "M", "github.com/gopherjs/gopherjs/js", null);
	S = $pkg.S = $newType(12, "Slice", "js.S", "S", "github.com/gopherjs/gopherjs/js", null);
...
$packages["main"] = (function() {
	var $pkg = {}, js = $packages["github.com/gopherjs/gopherjs/js"], console, json, localStorage, vue, router, Save, Fetch, init, main;
	Save = $pkg.Save = function(val) {
		var jsonStr;
		jsonStr = json.stringify($externalize(val, $emptyInterface));
		localStorage.setItem($externalize("todos-vuejs", $String), jsonStr);
	};
	Fetch = $pkg.Fetch = function() {
		var item, obj;
		item = localStorage.getItem($externalize("todos-vuejs", $String));
		if (item === null) {
			return $ifaceNil;
		}
		obj = json.parse(item);
	...
	init = function() {
		...
		if (Fetch() === $ifaceNil) {
			Save(new js.S([new js.M((_map = new $Map(), _key = "title", _map[_key] = { k: _key, v: new $String("Program in Gopher.js") }, _key = "completed", _map[_key] = { k: _key, v: new $Bool(false) }, _map)), new js.M((_map$1 = new $Map(), _key$1 = "title", _map$1[_key$1] = { k: _key$1, v: new $String("Finish another TodoMvc Sample") }, _key$1 = "completed", _map$1[_key$1] = { k: _key$1, v: new $Bool(true) }, _map$1))]));
		}
	};
	main = function() {
		var app, _map, _key, _map$1, _key$1, _map$2, _key$2, _map$3, _key$3, _map$4, _key$4, _map$5, _key$5, _map$6, _key$6, _map$7, _key$7, vue$1, router$1, keys, _map$8, _key$8;
		app = (_map = new $Map(), _key = "el", _map[_key] = { k: _key, v: new $String("#todoapp") }, _key = "data", _map[_key] = { k: _key, v: new js.M((_map$1 = new $Map(), _key$1 = "todos", _map$1[_key$1] = { k: _key$1, v: Fetch() }, _key$1 = "newTodo", _map$1[_key$1] = { k: _key$1, v: new $String("") }, _key$1 = "editedTodo", _map$1[_key$1] = { k: _key$1, v: $ifaceNil }, _key$1 = "activeFilter", _map$1[_key$1] = { k: _key$1, v: new $String("all") }, _key$1 = "filters", _map$1[_key$1] = { k: _key$1, v: new js.M((_map$2 = new $Map(), _key$2 = "all", _map$2[_key$2] = { k: _key$2, v: new ($funcType([], [$emptyInterface], false))((function() {
			return new $Bool(true);
		})) }, _key$2 = "active", _map$2[_key$2] = { k: _key$2, v: new ($funcType([js.Object], [$emptyInterface], false))((function(todo) {
			return new $Bool(!!!(todo.completed));
		})) }, _key$2 = "completed", _map$2[_key$2] = { k: _key$2, v: new ($funcType([js.Object], [$emptyInterface], false))((function(todo) {
			return new $Bool(!!(todo.completed));
		})) }, _map$2)) }, _map$1)) }, _key = "ready", _map[_key] = { k: _key, v: new ($funcType([], [], false))((function() {
			this.$watch($externalize("todos", $String), $externalize((function(newValue) {
				Save(newValue);
			}), ($funcType([js.S], [], false))), $externalize(true, $Bool));
		})) }, _key = "directives", _map[_key] = { k: _key, v: new js.M((_map$3 = new $Map(), _key$3 = "todo-focus", _map$3[_key$3] = { k: _key$3, v: new ($funcType([js.Object], [], false))((function(v) {
			var el;
			if (!!(v) === false) {
				return;
			}
		...
		})) }, _map$3)) }, _key = "filters", _map[_key] = { k: _key, v: new js.M((_map$4 = new $Map(), _key$4 = "filterTodos", _map$4[_key$4] = { k: _key$4, v: new ($funcType([js.Object], [js.Object], false))((function(todos) {
			var filters, activeFilter, filterTodos;
			filters = this.filters;
			activeFilter = $internalize(this.activeFilter, $String);
			filterTodos = todos.filter(filters[$externalize(activeFilter, $String)]);
			return filterTodos;
		})) }, _map$4)) }, _key = "computed", _map[_key] = { k: _key, v: new js.M((_map$5 = new $Map(), _key$5 = "remaining", _map$5[_key$5] = { k: _key$5, v: new ($funcType([], [js.Object], false))((function() {
			var activeFilterFn, activeTodosLen;
			activeFilterFn = this.filters.active;
			activeTodosLen = this.todos.filter(activeFilterFn).length;
			return activeTodosLen;
		})) }, _key$5 = "allDone", _map$5[_key$5] = { k: _key$5, v: new js.M((_map$6 = new $Map(), _key$6 = "get", _map$6[_key$6] = { k: _key$6, v: new ($funcType([], [$emptyInterface], false))((function() {
			return new $Bool((($parseInt(this.remaining) >> 0) === 0));
		})) }, _key$6 = "set", _map$6[_key$6] = { k: _key$6, v: new ($funcType([js.Object], [], false))((function(done) {
			this.todos.forEach($externalize((function(item) {
				item.completed = $externalize(!!(done), $Bool);
			}), ($funcType([js.Object], [], false))));
		})) }, _map$6)) }, _map$5)) }, _key = "methods", _map[_key] = { k: _key, v: new js.M((_map$7 = new $Map(), _key$7 = "addTodo", _map$7[_key$7] = { k: _key$7, v: new ($funcType([], [], false))((function() {
			var newToDoStr, _map$8, _key$8;
			newToDoStr = $internalize(this.newTodo.trim(), $String);
			if (newToDoStr.length === 0) {
				return;
			}
			this.todos.push($externalize((_map$8 = new $Map(), _key$8 = "title", _map$8[_key$8] = { k: _key$8, v: new $String(newToDoStr) }, _key$8 = "completed", _map$8[_key$8] = { k: _key$8, v: new $Bool(false) }, _map$8), js.M));
			this.newTodo = $externalize("", $String);
		})) }, _key$7 = "removeTodo", _map$7[_key$7] = { k: _key$7, v: new ($funcType([js.Object], [], false))((function(todo) {
			this.todos.$remove(todo.$data);
		})) }, _key$7 = "editTodo", _map$7[_key$7] = { k: _key$7, v: new ($funcType([js.Object], [], false))((function(todo) {
			this.beforeEditCache = todo.title;
			this.editedTodo = todo;
		})) }, _key$7 = "doneEdit", _map$7[_key$7] = { k: _key$7, v: new ($funcType([js.Object], [$emptyInterface], false))((function(todo) {
			if ($internalize(this.editedTodo, $String).length <= 0) {
				return new $Bool(true);
			}
			this.editedTodo = null;
			todo.title = $externalize($internalize(todo.title.trim(), $String), $String);
			if ($internalize(todo.title, $String).length === 0) {
				this.removeTodo(todo);
			}
			return new $Bool(true);
		})) }, _key$7 = "cancelEdit", _map$7[_key$7] = { k: _key$7, v: new ($funcType([js.Object], [], false))((function(todo) {
			this.editedTodo = null;
			todo.title = this.beforeEditCache;
		})) }, _key$7 = "removeCompleted", _map$7[_key$7] = { k: _key$7, v: new ($funcType([], [], false))((function() {
			var activeFilterFn, activeTodos;
			activeFilterFn = this.filters.active;
			activeTodos = this.todos.filter(activeFilterFn);
			this.todos = activeTodos;
		})) }, _map$7)) }, _map);
		vue$1 = new (vue)($externalize(app, js.M));
		$global.app = vue$1;
		router$1 = new (router)();
		keys = $global.Object.keys(vue$1.filters);
		keys.forEach($externalize((function(filter) {
			router$1.on(filter, $externalize((function() {
				vue$1.activeFilter = filter;
			}), ($funcType([], [], false))));
		}), ($funcType([js.Object], [], false))));
		router$1.configure($externalize((_map$8 = new $Map(), _key$8 = "notfound", _map$8[_key$8] = { k: _key$8, v: new ($funcType([], [], false))((function() {
			$global.location.hash = $externalize("", $String);
			vue$1.activeFilter = $externalize("all", $String);
		})) }, _map$8), js.M));
		router$1.init();
	};
	$pkg.$run = function($b) {
